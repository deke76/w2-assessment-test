...
const range = function(count, skipZero = false, descending = false) {
  let arrReturn = [];
  let index = 0 + skipZero;
  let end = count - !skipZero;
  let countBy = 1;
  if (descending) {
    let temp = index;
    index = end;
...
console.log(range(5, false, true));
console.log(range(7, true, true));
console.log(range(2));
console.log(range(1));
console.log(range(0, false, true));
console.log(range('10', false, true));
